...
export const fetchProducts = (queryString) => async (dispatch) => {
    try {
        ...
        dispatch({ 
            type: "IS_ERROR",
            payload: error?.response?.message || "Failed to fetch products",
        });
...
export const fetchCategories = (queryString) => async (dispatch) => {
    try {
        ...
        dispatch({ 
            type: "IS_ERROR",
            payload: error?.response?.message || "Failed to fetch categories",
        });
...
export const getUserAddresses = () => async (dispatch, getState) => {
    try {
        ...
        dispatch({ 
            type: "IS_ERROR",
            payload: error?.response?.message || "Failed to fetch user address",
        });
...
export const deleteUserAddresses = (toast, addressId, setOpenDeleteModal) => async (dispatch, getState) => {
    try {
        ...
        dispatch({ 
            type: "IS_ERROR",
            payload: error?.response?.message || "Some error occured",
        });
...
export const createUserCart = (sendCartItems) => async (dispatch, getState) => {
    try {
        ...
        dispatch({ 
            type: "IS_ERROR",
            payload: error?.response?.message || "Failed to create cart items",
        });
...
export const getUserCart = () => async (dispatch, getState) => {
    try {
        ...
        dispatch({ 
            type: "IS_ERROR",
            payload: error?.response?.message || "Failed to fetch cart items",
        });
